...
__author__ = 'Bobby McBobberson'
__email__ = 'bob@rob.com'
__version__ = '0.1.0'


class UuidChecker(object):
    """
    ...
    message_I200 = "I200 Cats in hats."
    ...
    def rule_I200(self, node):
        if isinstance(node, ast.FunctionDef):
            ...
            if not marked:
                print('HELLO')
                yield (line_num, 0, self.message_I200, type(self))
